...
//复位DS18B20
//#define DS18B20_IO_IN()  {GPIOA->CR&=0XF0FFFFFF;GPIOA->CRL|=8<<0;}
//#define DS18B20_IO_OUT() {GPIOA->CRL&=0XF0FFFFFF;GPIOA->CRL|=3<<0;}

#define	DS18B20_DQ_OUT PCout(14) //数据端口	PA0
#define	DS18B20_DQ_IN  PCin(14)  //数据端口	PA0
static void DS18B20_IO_IN()
{
...
u8 DS18B20_Init(void)
{
    ...
    GPIO_Initure.Pin=GPIO_PIN_14;           	//PA0
